      ...
      <div className="flex flex-col items-center justify-center p-10">
        ...
        <div className="w-full sm:w-[90%] flex items-center justify-between mb-[100px]">
          ...
          <div className="w-[50%] text-[#061E5B] text-[12px] sm:text-[14px] flex flex-col justify-between py-2 font-GmarketLight h-[115px] sm:h-[170px]">
            <p>
              투명한 명지의 줄임말로, 학생회비 사용 내역을 투명하고 간편하게
              조회할 수 있는 서비스입니다.
            </p>
            <br />
            <p>
              영어로는 To MyongJi 로, 명지대 학생들에게 라는 의미 또한 가지고
              있습니다 :)
            </p>
          </div>
        </div>
        ...
        {/* 조회 버튼 */}
        <div className="w-full sm:w-[90%] flex items-center justify-between mb-[100px]">
          <div className="w-[45%] text-[#061E5B] font-GmarketLight text-[12px] sm:text-[14px] p-1">
            메뉴의 조회를 클릭하여 원하는 대학과 소속을 선택하면 해당 학생회의
            학생회비 사용 내역 조회가 가능합니다.
          </div>
          <div className="w-[45%] flex justify-end">
            <IntroduceImageCard
              image={receiptList}
              text={"*해당 이미지는 실제 데이터가 아닌 예시 화면입니다."}
            />
          </div>
        </div>
        {/* 작성 버튼 */}
        <div className="w-full sm:w-[90%] flex items-center justify-between mb-[100px]">
          ...
          <div className="w-[45%]">
            <IntroduceCard
              contentText={
                "학생회 소속일 경우 수기 또는 다양한 방법을 통해 영수증 작성이 가능합니다."
              }
